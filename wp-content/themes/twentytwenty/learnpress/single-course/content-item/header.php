...
<div id="course-item-content-header">
    ...
    <div class="course-item-search">
        <form class="course-header-search-form">
    ...
    <form class="lp-form form-button lp-button-back course-header-back-button" method="post" action="<?php echo $course->get_permalink(); ?>">
